...
public class Task1 {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Виявлення помилки читання неправильного місяця
         */
        try {
            while ( choice != 11) {
            switch (choice){
    ...
    /**
     * Методи 8, 9, 10 рахуванна парної чи непарної кількості днів місяців
     */
    ...
    /**
     * Виведення попередньої та наступної пори року (мет. 6, 7)
     */
    ...
    /**
     * Методи рахування ї кількості днів (мет. 3, 4, 5)
     */
    ...
    /**
     * Метод виявлення наявності місяця
     * @throws WrongInputConsoleParametersException
     */
    private static void method1() throws WrongInputConsoleParametersException {
        ...
        if (monthFinded != false){
            ...
            throw new WrongInputConsoleParametersException("Такого місяця не існyє", month);
//            System.out.println("Такого місяця не існyє :( ");
        }
    }
